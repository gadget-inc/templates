...
export const groupByDateBuckets = (
  data: ChatSubset[] | null | undefined,
  ...
  return groupBy(data, (item) => {
    ...
    if (itemDate >= sevenDaysAgoStart && itemDate < yesterdayStart)
      return "Previous 7 days";
    if (itemDate >= thirtyDaysAgoStart && itemDate < sevenDaysAgoStart)
