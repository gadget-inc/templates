 ...
 *
 * View and edit your roles and permissions in the Gadget editor at https://slack-notification-template.gadget.app/edit/settings/permissions
 */
    ...
    "shopify-app-users": {
      ...
      models: {
        shopifyCustomer: {
          read: {
            filter:
              "accessControl/filters/shopifyCustomer/shopifyCustomer.gelly",
          },
        },
        shopifyGdprRequest: {
          read: {
