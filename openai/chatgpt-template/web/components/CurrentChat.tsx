...
const Message = (props: {
  ...
  return (
    <Flex
      bgColor={role === "assistant" ? "gray.600" : undefined}
...
const CurrentChat = (props: { user: User }) => {
  const { user } = props;
      ...
      <Box position="sticky" marginTop="auto" bottom={0} bgColor="gray.700">
        <Flex direction="column" py={2} alignItems="center" gap={3}>
          ...
          <Text fontSize="xs" color="gray.500">
            This is a ChatGPT clone built in 30 minutes with{" "}
            <Link color="white" href="https://gadget.dev" isExternal>
              gadget.dev
            </Link>
          </Text>
        </Flex>
