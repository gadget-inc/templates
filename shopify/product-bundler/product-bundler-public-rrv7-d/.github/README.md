...
[![Fork template](https://img.shields.io/badge/Fork%20template-%233A0CFF?style=for-the-badge)](https://app.gadget.dev/auth/fork?domain=product-bundler-public-rrv7-d.gadget.app)
...
- Frontend
  ...
  - `index`: Displays a list of created bundles, expandable to show their components and quantities.
  - `bundle`: Manages both the creation and update of bundles.
