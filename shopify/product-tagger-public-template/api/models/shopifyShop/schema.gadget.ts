...
// This file describes the schema for the "shopifyShop" model, go to https://product-tagger-public-template.gadget.app/edit to view/edit your model in Gadget
