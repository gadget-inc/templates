  ...
  btn.onclick = () => {
    ...
    form.addEventListener("submit", async (event) => {
      ...
      const wishlistResponse = await fetch(
        `${window.shopURL}/apps/wishlist-p-r-spa/wishlist/create`,
        {
          method: "POST",
          headers: {
...
async function handleWishlistClick(e) {
  ...
  if (current) {
    ...
    const deleteResponse = await fetch(
      `${window.shopURL}/apps/wishlist-p-r-spa/wishlist/item/remove`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    const addResponse = await fetch(
      `${window.shopURL}/apps/wishlist-p-r-spa/wishlist/item/create`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
