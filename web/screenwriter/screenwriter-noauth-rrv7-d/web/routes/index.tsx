...
export default function() {
  const { exists } = useLoaderData();
  const [hideGettingStarted, setHideGettingStarted] = useState(exists);
          ...
          <CardContent>
            ...
            >
              {options.map((option, i) => (
                <div
                  key={i}
                  className={`flex items-center space-x-2 p-3 rounded-md ${option.title === choice
